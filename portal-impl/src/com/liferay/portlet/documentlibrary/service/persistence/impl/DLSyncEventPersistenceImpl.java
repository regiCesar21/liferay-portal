...
public class DLSyncEventPersistenceImpl
	...
	public List<DLSyncEvent> findByModifiedTime(
		...
		if (useFinderCache) {
			list = (List<DLSyncEvent>)FinderCacheUtil.getResult(
	...
	public DLSyncEvent findByModifiedTime_First(
		...
		throw new NoSuchSyncEventException(sb.toString());
	}
	...
	public DLSyncEvent remove(Serializable primaryKey)
		...
		try {
			...
			if (dlSyncEvent == null) {
				...
				throw new NoSuchSyncEventException(
					_NO_SUCH_ENTITY_WITH_PRIMARY_KEY + primaryKey);
			}

			return remove(dlSyncEvent);
		}
		catch (NoSuchSyncEventException noSuchEntityException) {
