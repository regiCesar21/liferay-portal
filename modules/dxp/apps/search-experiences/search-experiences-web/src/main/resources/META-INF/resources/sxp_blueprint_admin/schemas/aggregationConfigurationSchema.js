		...
		Aggregations: {
			properties: {
				...
				moving_function: {
					...
					required: ['buckets_path', 'script', 'window'],
					type: 'object',
				},
				nested: {
					allOf: [
				...
				scripted_metric: {
					...
					required: ['combine_script', 'map_script', 'reduce_script'],
					type: 'object',
				},
				serial_differencing: {
					allOf: [
