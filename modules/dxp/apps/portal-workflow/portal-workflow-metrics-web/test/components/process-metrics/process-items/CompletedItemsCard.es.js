...
describe('The completed items card component should', () => {
	...
	test.skip('Be rendered with time range filter', async () => {
	...
	test.skip('Be rendered with overdue count "1"', () => {
	...
	test.skip('Be rendered with onTime count "2"', () => {
		const panelBody = container.querySelector('.panel-body');
	...
	test.skip('Be rendered with untracked count "3"', () => {
		const panelBody = container.querySelector('.panel-body');
	...
	test.skip('Be rendered with total completed count "6"', () => {
		const panelBody = container.querySelector('.panel-body');
