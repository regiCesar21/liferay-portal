...
public class AreaResourceFactoryImpl implements AreaResource.Factory {
	...
	public AreaResource.Builder create() {
		return new AreaResource.Builder() {
			...
			public AreaResource build() {
				...
				Function<InvocationHandler, AreaResource>
					areaResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_areaResourceProxyProviderFunction;

				return areaResourceProxyProviderFunction.apply(
			...
			@Override
			public AreaResource.Builder uriInfo(UriInfo uriInfo) {
				_uriInfo = uriInfo;
	...
	private Object _invoke(
		...
		areaResource.setContextUriInfo(uriInfo);
		...
		areaResource.setSortParserProvider(_sortParserProvider);
