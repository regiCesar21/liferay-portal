INSERT INTO IdentityActivitySummary (activitiesCount, channelId, dataSourceId, eventId, firstActivityDate, identityId, individualId, lastActivityDate) VALUES (1, 1, 1, 'webContentViewed', timestamp '${now}', '1', '1', timestamp '${now}');
INSERT INTO IdentityActivitySummary (activitiesCount, channelId, dataSourceId, eventId, firstActivityDate, identityId, individualId, lastActivityDate) VALUES (1, 1, 1, 'webContentViewed', timestamp '${now-5d}', '2', '2', timestamp '${now-5d}');
INSERT INTO IdentityActivitySummary (activitiesCount, channelId, dataSourceId, eventId, firstActivityDate, identityId, individualId, lastActivityDate) VALUES (1, 1, 1, 'webContentViewed', timestamp '${now-10d}', '3', '3', timestamp '${now-10d}');
INSERT INTO IdentityActivitySummary (activitiesCount, channelId, dataSourceId, eventId, firstActivityDate, identityId, individualId, lastActivityDate) VALUES (1, 1, 1, 'webContentViewed', timestamp '${now-10d}', '4', '4', timestamp '${now-10d}');
INSERT INTO IdentityActivitySummary (activitiesCount, channelId, dataSourceId, eventId, firstActivityDate, identityId, individualId, lastActivityDate) VALUES (1, 1, 1, 'webContentViewed', timestamp '${now-15d}', '5', '5', timestamp '${now-15d}');
INSERT INTO IdentityActivitySummary (activitiesCount, channelId, dataSourceId, eventId, firstActivityDate, identityId, individualId, lastActivityDate) VALUES (1, 1, 1, 'webContentViewed', timestamp '${now-20d}', '6', '6', timestamp '${now-20d}');
INSERT INTO IdentityActivitySummary (activitiesCount, channelId, dataSourceId, eventId, firstActivityDate, identityId, individualId, lastActivityDate) VALUES (1, 1, 1, 'webContentViewed', timestamp '${now-20d}', '7', '7', timestamp '${now-20d}');
