...
INSERT INTO DocumentLibraryDaily (assetId, assetTitle, channelId, comments, downloads, eventDate, impressions, userId) VALUES ('zsrwerf', 'Document 1', 1, 1, 1, TIMESTAMP(DATETIME_TRUNC(timestamp '${now}', HOUR)), 1, '1');
INSERT INTO DocumentLibraryDaily (assetId, assetTitle, channelId, comments, downloads, eventDate, impressions, userId) VALUES ('zsrwerf', 'Document 1', 1, 2, 2, TIMESTAMP(DATETIME_TRUNC(timestamp '${now-1d}', HOUR)), 1, '1');
INSERT INTO DocumentLibraryDaily (assetId, assetTitle, channelId, comments, downloads, eventDate, impressions, userId) VALUES ('zsrwerf', 'Document 1', 1, 3, 3, TIMESTAMP(DATETIME_TRUNC(timestamp '${now-2d}', HOUR)), 1, '1');
INSERT INTO DocumentLibraryDaily (assetId, assetTitle, channelId, comments, downloads, eventDate, impressions, userId) VALUES ('zsrwerf', 'Document 1', 1, 1, 1, TIMESTAMP(DATETIME_TRUNC(timestamp '${now-6d}', HOUR)), 1, '2');
INSERT INTO DocumentLibraryDaily (assetId, assetTitle, channelId, comments, downloads, eventDate, impressions, userId) VALUES ('zsrwerf', 'Document 1', 1, 2, 2, TIMESTAMP(DATETIME_TRUNC(timestamp '${now-8d}', HOUR)), 1, '2');
INSERT INTO DocumentLibraryDaily (assetId, assetTitle, channelId, comments, downloads, eventDate, impressions, userId) VALUES ('zsrwerf', 'Document 1', 1, 3, 3, TIMESTAMP(DATETIME_TRUNC(timestamp '${now-8d}', HOUR)), 1, '1');
INSERT INTO DocumentLibraryDaily (assetId, assetTitle, channelId, comments, downloads, eventDate, impressions, userId) VALUES ('zsrwerf', 'Document 1', 1, 1, 1, TIMESTAMP(DATETIME_TRUNC(timestamp '${now-9d}', HOUR)), 1, '1');
INSERT INTO DocumentLibraryDaily (assetId, assetTitle, channelId, comments, downloads, eventDate, impressions, userId) VALUES ('zsrwerf', 'Document 1', 1, 2, 2, TIMESTAMP(DATETIME_TRUNC(timestamp '${now-12d}', HOUR)), 1, '2');
INSERT INTO DocumentLibraryDaily (assetId, assetTitle, channelId, comments, downloads, eventDate, impressions, userId) VALUES ('zsrwerf', 'Document 1', 1, 3, 3, TIMESTAMP(DATETIME_TRUNC(timestamp '${now-14d}', HOUR)), 1, '2');
