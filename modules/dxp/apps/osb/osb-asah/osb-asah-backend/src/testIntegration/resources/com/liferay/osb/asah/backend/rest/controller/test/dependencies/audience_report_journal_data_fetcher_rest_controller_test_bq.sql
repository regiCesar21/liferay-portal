...
INSERT INTO JournalDaily (assetId, assetTitle, channelId, eventDate, userId, views) VALUES ('Journal1', 'Web Content Title 1', 12345, TIMESTAMP '${today-4d}', 'identity_a', 1);
INSERT INTO JournalDaily (assetId, assetTitle, channelId, eventDate, userId, views) VALUES ('Journal1', 'Web Content Title 1', 12345, TIMESTAMP '${today-4d}', 'identity_b', 1);
INSERT INTO JournalDaily (assetId, assetTitle, channelId, eventDate, userId, views) VALUES ('Journal2', 'Web Content Title 2', 12345, TIMESTAMP '${today-4d}', 'identity_c', 1);
