...
INSERT INTO Session (bounce, channelId, duration, id, sessionEnd, sessionStart, userId) values (1, 1, 60000, 'session1', TIMESTAMP '${today-5dT14:00:00.000Z}', TIMESTAMP '${today-5dT13:00:00.000Z}', 'identity1');
INSERT INTO Session (bounce, channelId, duration, id, sessionEnd, sessionStart, userId) values (1, 1, 60000, 'session2', TIMESTAMP '${today-5dT14:00:00.000Z}', TIMESTAMP '${today-5dT13:00:00.000Z}', 'identity2');
INSERT INTO Session (bounce, channelId, duration, id, sessionEnd, sessionStart, userId) values (1, 1, 60000, 'session3', TIMESTAMP '${today-5dT14:00:00.000Z}', TIMESTAMP '${today-5dT13:00:00.000Z}', 'identity5');
INSERT INTO Session (bounce, channelId, duration, id, sessionEnd, sessionStart, userId) values (1, 1, 60000, 'session4', TIMESTAMP '${today-5dT14:00:00.000Z}', TIMESTAMP '${today-5dT13:00:00.000Z}', 'identity6');
INSERT INTO Session (bounce, channelId, duration, id, sessionEnd, sessionStart, userId) values (1, 1, 60000, 'session5', TIMESTAMP '${today-4dT14:00:00.000Z}', TIMESTAMP '${today-4dT13:00:00.000Z}', 'identity2');
INSERT INTO Session (bounce, channelId, duration, id, sessionEnd, sessionStart, userId) values (1, 1, 60000, 'session6', TIMESTAMP '${today-4dT14:00:00.000Z}', TIMESTAMP '${today-4dT13:00:00.000Z}', 'identity6');
INSERT INTO Session (bounce, channelId, duration, id, sessionEnd, sessionStart, userId) values (1, 1, 60000, 'session7', TIMESTAMP '${today-4dT14:00:00.000Z}', TIMESTAMP '${today-4dT13:00:00.000Z}', 'identity1');
INSERT INTO Session (bounce, channelId, duration, id, sessionEnd, sessionStart, userId) values (1, 1, 60000, 'session8', TIMESTAMP '${today-1dT14:00:00.000Z}', TIMESTAMP '${today-1dT13:00:00.000Z}', 'identity7');
