INSERT INTO FormDaily (assetId, assetTitle, canonicalUrl, channelId, eventDate, submissions, userId) VALUES ('Form1', 'Form 1', 'https://www.beryl.com/forms/form-1', 12345, TIMESTAMP '${today-4d}', 1, 'identity_a');
INSERT INTO FormDaily (assetId, assetTitle, canonicalUrl, channelId, eventDate, submissions, userId) VALUES ('Form1', 'Form 1', 'https://www.beryl.com/forms/form-1', 12345, TIMESTAMP '${today-4d}', 1, 'identity_b');
INSERT INTO FormDaily (assetId, assetTitle, canonicalUrl, channelId, eventDate, submissions, userId) VALUES ('Form2', 'Form 2', 'https://www.beryl.com/forms/form-2', 12345, TIMESTAMP '${today-4d}', 1, 'identity_c');
