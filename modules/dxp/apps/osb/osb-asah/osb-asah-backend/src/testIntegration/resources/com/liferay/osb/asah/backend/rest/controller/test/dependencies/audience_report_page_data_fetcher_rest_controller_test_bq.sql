...
INSERT INTO PageDaily (canonicalUrl, channelId, eventDate, title, userId, views) VALUES ('https://www.beryl.com/page-1', 12345, TIMESTAMP(DATETIME_TRUNC(timestamp '${today-4d}', HOUR)), 'Page Title 1', 'identity_a', 1);
INSERT INTO PageDaily (canonicalUrl, channelId, eventDate, title, userId, views) VALUES ('https://www.beryl.com/page-1', 12345, TIMESTAMP(DATETIME_TRUNC(timestamp '${today-4d}', HOUR)), 'Page Title 1', 'identity_b', 1);
INSERT INTO PageDaily (canonicalUrl, channelId, eventDate, title, userId, views) VALUES ('https://www.beryl.com/page-2', 12345, TIMESTAMP(DATETIME_TRUNC(timestamp '${today-4d}', HOUR)), 'Page Title 2', 'identity_c', 1);
