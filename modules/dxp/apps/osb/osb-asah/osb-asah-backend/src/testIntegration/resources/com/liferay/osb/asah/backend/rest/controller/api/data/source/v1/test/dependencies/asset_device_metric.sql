...
INSERT INTO DocumentLibraryDaily (assetId, assetTitle, channelId, comments, deviceType, downloads, eventDate, impressions, userId) VALUES ('zsrwerf', 'Document 1', 1, 3, 'Tablet', 2, TIMESTAMP(DATETIME_TRUNC(timestamp '${now-2d}', HOUR)), 7, '1');
INSERT INTO DocumentLibraryDaily (assetId, assetTitle, channelId, comments, deviceType, downloads, eventDate, impressions, userId) VALUES ('zsrwerf', 'Document 1', 1, 4, 'Mobile', 1, TIMESTAMP(DATETIME_TRUNC(timestamp '${now-6d}', HOUR)), 4, '2');
