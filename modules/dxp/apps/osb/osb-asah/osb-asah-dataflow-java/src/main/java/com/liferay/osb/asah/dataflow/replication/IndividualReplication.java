 ...
 */
public class IndividualReplication {
	...
	public static void extend(
		...
		String[] individualColumns = StringUtils.split(
		...
		pipeline.apply(
			...
			JdbcIO.<String>write(
				...
				String.format(
					"insert into %s.individual(%s) values(%s)",
					postgreSQLReplicationPipelineOptions.getProjectId(),
					StringUtils.join(individualColumns, ","),
					StringUtils.repeat("?", ",", individualColumns.length))
