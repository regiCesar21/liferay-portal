...
/**
 * Provides the base implementation for the loop person local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.loop.service.impl.LoopPersonLocalServiceImpl}.
 * </p>
 *
 * @author Ethan Bustad
...
public abstract class LoopPersonLocalServiceBaseImpl
	...
	public LoopPerson addLoopPerson(LoopPerson loopPerson) {
		...
		return loopPersonPersistence.update(loopPerson);
	}
	...
	public LoopPerson deleteLoopPerson(LoopPerson loopPerson) {
		return loopPersonPersistence.remove(loopPerson);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return loopPersonPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public LoopPerson fetchLoopPerson(long loopPersonId) {
		return loopPersonPersistence.fetchByPrimaryKey(loopPersonId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setPrimaryKeyPropertyName("loopPersonId");
	...
	public List<LoopPerson> getLoopPersons(int start, int end) {
		return loopPersonPersistence.findAll(start, end);
	}
	...
	public int getLoopPersonsCount() {
		return loopPersonPersistence.countAll();
	}
	 ...
	 */
	public LoopPersonLocalService getLoopPersonLocalService() {
	...
	public void afterPropertiesSet() {
		...
		LoopPersonLocalServiceUtil.setService(loopPersonLocalService);
	}
	...
	public void destroy() {
		...
		LoopPersonLocalServiceUtil.setService(null);
	}
	...
	public String getOSGiServiceIdentifier() {
		return LoopPersonLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		DataSource dataSource = loopPersonPersistence.getDataSource();
	...
	private static final Log _log = LogFactoryUtil.getLog(
		LoopPersonLocalServiceBaseImpl.class);
