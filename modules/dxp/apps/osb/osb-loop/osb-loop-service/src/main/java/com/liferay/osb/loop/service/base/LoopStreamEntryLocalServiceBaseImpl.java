...
import com.liferay.osb.loop.service.LoopStreamEntryLocalService;
...
/**
 * Provides the base implementation for the loop stream entry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.loop.service.impl.LoopStreamEntryLocalServiceImpl}.
 * </p>
 *
 * @author Ethan Bustad
 * @see com.liferay.osb.loop.service.impl.LoopStreamEntryLocalServiceImpl
 * @generated
 */
public abstract class LoopStreamEntryLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, LoopStreamEntryLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>LoopStreamEntryLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>LoopStreamEntryLocalServiceUtil</code>.
	 */
	 ...
	 *
	 * <p>
	 * <strong>Important:</strong> Inspect LoopStreamEntryLocalServiceImpl for overloaded versions of the method. If provided, use these entry points to the API, as the implementation logic may require the additional parameters defined there.
	 * </p>
	 *
	...
	@Override
	public LoopStreamEntry addLoopStreamEntry(LoopStreamEntry loopStreamEntry) {
		loopStreamEntry.setNew(true);

		return loopStreamEntryPersistence.update(loopStreamEntry);
	}
	...
	public LoopStreamEntry createLoopStreamEntry(long loopStreamEntryId) {
		return loopStreamEntryPersistence.create(loopStreamEntryId);
	}
	...
	@Override
	public LoopStreamEntry deleteLoopStreamEntry(long loopStreamEntryId)
		throws PortalException {

		return loopStreamEntryPersistence.remove(loopStreamEntryId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public LoopStreamEntry deleteLoopStreamEntry(
		LoopStreamEntry loopStreamEntry) {

		return loopStreamEntryPersistence.remove(loopStreamEntry);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			LoopStreamEntry.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return loopStreamEntryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return loopStreamEntryPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return loopStreamEntryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return loopStreamEntryPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public LoopStreamEntry fetchLoopStreamEntry(long loopStreamEntryId) {
		return loopStreamEntryPersistence.fetchByPrimaryKey(loopStreamEntryId);
	}
	 ...
	 */
	@Override
	public LoopStreamEntry getLoopStreamEntry(long loopStreamEntryId)
		throws PortalException {

		return loopStreamEntryPersistence.findByPrimaryKey(loopStreamEntryId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(loopStreamEntryLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(LoopStreamEntry.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("loopStreamEntryId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(LoopStreamEntry.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return loopStreamEntryLocalService.deleteLoopStreamEntry(
			(LoopStreamEntry)persistedModel);
	}

	public BasePersistence<LoopStreamEntry> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return loopStreamEntryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<LoopStreamEntry> getLoopStreamEntries(int start, int end) {
		return loopStreamEntryPersistence.findAll(start, end);
	}
	...
	public int getLoopStreamEntriesCount() {
		return loopStreamEntryPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public LoopStreamEntry updateLoopStreamEntry(
		LoopStreamEntry loopStreamEntry) {
	 ...
	 */
	public LoopStreamEntryLocalService getLoopStreamEntryLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"com.liferay.osb.loop.model.LoopStreamEntry",
			loopStreamEntryLocalService);

		LoopStreamEntryLocalServiceUtil.setService(loopStreamEntryLocalService);
	}
	...
	public void destroy() {
		...
		LoopStreamEntryLocalServiceUtil.setService(null);
	}
	...
	public String getOSGiServiceIdentifier() {
		return LoopStreamEntryLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		DataSource dataSource = loopStreamEntryPersistence.getDataSource();
	...
	@BeanReference(type = LoopStreamEntryLocalService.class)
	protected LoopStreamEntryLocalService loopStreamEntryLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		LoopStreamEntryLocalServiceBaseImpl.class);
