...
import com.liferay.osb.loop.service.LoopPersonRelLocalService;
...
/**
 * Provides the base implementation for the loop person rel local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.loop.service.impl.LoopPersonRelLocalServiceImpl}.
 * </p>
 *
 * @author Ethan Bustad
 * @see com.liferay.osb.loop.service.impl.LoopPersonRelLocalServiceImpl
 * @generated
 */
public abstract class LoopPersonRelLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, LoopPersonRelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>LoopPersonRelLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>LoopPersonRelLocalServiceUtil</code>.
	 */
	 ...
	 *
	 * <p>
	 * <strong>Important:</strong> Inspect LoopPersonRelLocalServiceImpl for overloaded versions of the method. If provided, use these entry points to the API, as the implementation logic may require the additional parameters defined there.
	 * </p>
	 *
	...
	@Override
	public LoopPersonRel addLoopPersonRel(LoopPersonRel loopPersonRel) {
		loopPersonRel.setNew(true);

		return loopPersonRelPersistence.update(loopPersonRel);
	}
	...
	public LoopPersonRel createLoopPersonRel(long loopPersonRelId) {
		return loopPersonRelPersistence.create(loopPersonRelId);
	}
	...
	@Override
	public LoopPersonRel deleteLoopPersonRel(long loopPersonRelId)
		throws PortalException {

		return loopPersonRelPersistence.remove(loopPersonRelId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public LoopPersonRel deleteLoopPersonRel(LoopPersonRel loopPersonRel) {
		return loopPersonRelPersistence.remove(loopPersonRel);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			LoopPersonRel.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return loopPersonRelPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return loopPersonRelPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return loopPersonRelPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return loopPersonRelPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public LoopPersonRel fetchLoopPersonRel(long loopPersonRelId) {
		return loopPersonRelPersistence.fetchByPrimaryKey(loopPersonRelId);
	}
	 ...
	 */
	@Override
	public LoopPersonRel getLoopPersonRel(long loopPersonRelId)
		throws PortalException {

		return loopPersonRelPersistence.findByPrimaryKey(loopPersonRelId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(loopPersonRelLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(LoopPersonRel.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("loopPersonRelId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(LoopPersonRel.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return loopPersonRelLocalService.deleteLoopPersonRel(
			(LoopPersonRel)persistedModel);
	}

	public BasePersistence<LoopPersonRel> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return loopPersonRelPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<LoopPersonRel> getLoopPersonRels(int start, int end) {
		return loopPersonRelPersistence.findAll(start, end);
	}
	...
	public int getLoopPersonRelsCount() {
		return loopPersonRelPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public LoopPersonRel updateLoopPersonRel(LoopPersonRel loopPersonRel) {
		return loopPersonRelPersistence.update(loopPersonRel);
	}
	 ...
	 */
	public LoopPersonRelLocalService getLoopPersonRelLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"com.liferay.osb.loop.model.LoopPersonRel",
			loopPersonRelLocalService);

		LoopPersonRelLocalServiceUtil.setService(loopPersonRelLocalService);
	}
	...
	public void destroy() {
		...
		LoopPersonRelLocalServiceUtil.setService(null);
	}
	...
	public String getOSGiServiceIdentifier() {
		return LoopPersonRelLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		DataSource dataSource = loopPersonRelPersistence.getDataSource();
	...
	@BeanReference(type = LoopPersonRelLocalService.class)
	protected LoopPersonRelLocalService loopPersonRelLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		LoopPersonRelLocalServiceBaseImpl.class);
