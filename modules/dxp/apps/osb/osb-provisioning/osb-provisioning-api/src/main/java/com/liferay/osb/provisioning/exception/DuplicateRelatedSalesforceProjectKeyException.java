 ...
 */
public class DuplicateRelatedSalesforceProjectKeyException extends PortalException {
	...
	public DuplicateRelatedSalesforceProjectKeyException(String msg, Throwable throwable) {
		super(msg, throwable);
	}
