...
<div class="info-container">
	...
	<c:if test="<%= (viewAccountDisplayContext.hasManageAccountsPermission() || viewAccountDisplayContext.hasManageGracePeriodPermission()) && (viewAccountDisplayContext.getLatestActiveProductPurchaseEndDate() != null) %>">
		<div>
			<clay:button
