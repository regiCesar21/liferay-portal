 ...
 */
@Component(service = UpgradeAccountPremiumService.class)
public class UpgradeAccountPremiumService extends UpgradeProcess {
	...
	private static final Log _log = LogFactoryUtil.getLog(
		UpgradeAccountPremiumService.class);
