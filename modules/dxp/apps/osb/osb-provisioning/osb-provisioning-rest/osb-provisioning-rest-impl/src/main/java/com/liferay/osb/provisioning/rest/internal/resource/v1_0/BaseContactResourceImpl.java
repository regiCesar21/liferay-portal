...
public abstract class BaseContactResourceImpl implements ContactResource {
	 ...
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/provisioning-rest/v1.0/contacts/{contactEmailAddress}/validate'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Operation(
		description = "Check if the provided email address exists or can be added."
	)
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/contacts/{contactEmailAddress}/validate")
