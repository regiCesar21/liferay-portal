...
public interface ContactResource {
	...
	public void getContactValidate(String contactEmailAddress) throws Exception;

	public HttpInvoker.HttpResponse getContactValidateHttpResponse(
	...
	public static class ContactResourceImpl implements ContactResource {
		...
		public void getContactValidate(String contactEmailAddress)
			throws Exception {

			HttpInvoker.HttpResponse httpResponse =
				getContactValidateHttpResponse(contactEmailAddress);
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/provisioning-rest/v1.0/contacts/{contactEmailAddress}/validate");
