...
/**
 * Provides the base implementation for the testray archive local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.testray.service.impl.TestrayArchiveLocalServiceImpl}.
 * </p>
 *
 * @author Ethan Bustad
 ...
 * @generated
 */
public abstract class TestrayArchiveLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, TestrayArchiveLocalService {
	...
	@Override
	public TestrayArchive addTestrayArchive(TestrayArchive testrayArchive) {
		testrayArchive.setNew(true);

		return testrayArchivePersistence.update(testrayArchive);
	}
	...
	public TestrayArchive createTestrayArchive(long testrayArchiveId) {
		return testrayArchivePersistence.create(testrayArchiveId);
	}
	...
	@Override
	public TestrayArchive deleteTestrayArchive(long testrayArchiveId)
		throws PortalException {

		return testrayArchivePersistence.remove(testrayArchiveId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public TestrayArchive deleteTestrayArchive(TestrayArchive testrayArchive) {
		return testrayArchivePersistence.remove(testrayArchive);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			TestrayArchive.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return testrayArchivePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return testrayArchivePersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return testrayArchivePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return testrayArchivePersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public TestrayArchive fetchTestrayArchive(long testrayArchiveId) {
		return testrayArchivePersistence.fetchByPrimaryKey(testrayArchiveId);
	}
	 ...
	 */
	@Override
	public TestrayArchive getTestrayArchive(long testrayArchiveId)
		throws PortalException {

		return testrayArchivePersistence.findByPrimaryKey(testrayArchiveId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(testrayArchiveLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(TestrayArchive.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("testrayArchiveId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(TestrayArchive.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return testrayArchiveLocalService.deleteTestrayArchive(
			(TestrayArchive)persistedModel);
	}

	public BasePersistence<TestrayArchive> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return testrayArchivePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<TestrayArchive> getTestrayArchives(int start, int end) {
		return testrayArchivePersistence.findAll(start, end);
	}
	...
	public int getTestrayArchivesCount() {
		return testrayArchivePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TestrayArchive updateTestrayArchive(TestrayArchive testrayArchive) {
		return testrayArchivePersistence.update(testrayArchive);
	}
	 ...
	 */
	public TestrayArchiveLocalService getTestrayArchiveLocalService() {
	...
	@Override
	public TestrayArchiveCompressedDataBlobModel getCompressedDataBlobModel(
		Serializable primaryKey) {

		Session session = null;

		try {
			session = testrayArchivePersistence.openSession();

			return (TestrayArchiveCompressedDataBlobModel)session.get(
				TestrayArchiveCompressedDataBlobModel.class, primaryKey);
		}
		catch (Exception exception) {
			throw testrayArchivePersistence.processException(exception);
		}
		finally {
			testrayArchivePersistence.closeSession(session);
		}
	}

	@Override
	@Transactional(readOnly = true)
	public InputStream openCompressedDataInputStream(long testrayArchiveId) {
		try {
			TestrayArchiveCompressedDataBlobModel
				TestrayArchiveCompressedDataBlobModel =
					getCompressedDataBlobModel(testrayArchiveId);

			Blob blob =
				TestrayArchiveCompressedDataBlobModel.getCompressedDataBlob();
	...
	public void afterPropertiesSet() {
		...
		TestrayArchiveLocalServiceUtil.setService(testrayArchiveLocalService);
	}
	...
	public void destroy() {
		...
		TestrayArchiveLocalServiceUtil.setService(null);
	}
	...
	public String getOSGiServiceIdentifier() {
		return TestrayArchiveLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		DataSource dataSource = testrayArchivePersistence.getDataSource();
	...
	@BeanReference(type = TestrayArchiveLocalService.class)
	protected TestrayArchiveLocalService testrayArchiveLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TestrayArchiveLocalServiceBaseImpl.class);
