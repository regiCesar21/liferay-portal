...
import com.liferay.osb.testray.service.TestrayFactorLocalService;
...
/**
 * Provides the base implementation for the testray factor local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.testray.service.impl.TestrayFactorLocalServiceImpl}.
 * </p>
 *
 * @author Ethan Bustad
 * @see com.liferay.osb.testray.service.impl.TestrayFactorLocalServiceImpl
 * @generated
 */
public abstract class TestrayFactorLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, TestrayFactorLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TestrayFactorLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>TestrayFactorLocalServiceUtil</code>.
	 */
	 ...
	 *
	 * <p>
	 * <strong>Important:</strong> Inspect TestrayFactorLocalServiceImpl for overloaded versions of the method. If provided, use these entry points to the API, as the implementation logic may require the additional parameters defined there.
	 * </p>
	 *
	...
	@Override
	public TestrayFactor addTestrayFactor(TestrayFactor testrayFactor) {
		testrayFactor.setNew(true);

		return testrayFactorPersistence.update(testrayFactor);
	}
	...
	public TestrayFactor createTestrayFactor(long testrayFactorId) {
		return testrayFactorPersistence.create(testrayFactorId);
	}
	...
	@Override
	public TestrayFactor deleteTestrayFactor(long testrayFactorId)
		throws PortalException {

		return testrayFactorPersistence.remove(testrayFactorId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public TestrayFactor deleteTestrayFactor(TestrayFactor testrayFactor) {
		return testrayFactorPersistence.remove(testrayFactor);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			TestrayFactor.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return testrayFactorPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return testrayFactorPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return testrayFactorPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return testrayFactorPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public TestrayFactor fetchTestrayFactor(long testrayFactorId) {
		return testrayFactorPersistence.fetchByPrimaryKey(testrayFactorId);
	}
	 ...
	 */
	@Override
	public TestrayFactor getTestrayFactor(long testrayFactorId)
		throws PortalException {

		return testrayFactorPersistence.findByPrimaryKey(testrayFactorId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(testrayFactorLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(TestrayFactor.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("testrayFactorId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(TestrayFactor.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return testrayFactorLocalService.deleteTestrayFactor(
			(TestrayFactor)persistedModel);
	}

	public BasePersistence<TestrayFactor> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return testrayFactorPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<TestrayFactor> getTestrayFactors(int start, int end) {
		return testrayFactorPersistence.findAll(start, end);
	}
	...
	public int getTestrayFactorsCount() {
		return testrayFactorPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TestrayFactor updateTestrayFactor(TestrayFactor testrayFactor) {
		return testrayFactorPersistence.update(testrayFactor);
	}
	 ...
	 */
	public TestrayFactorLocalService getTestrayFactorLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"com.liferay.osb.testray.model.TestrayFactor",
			testrayFactorLocalService);

		TestrayFactorLocalServiceUtil.setService(testrayFactorLocalService);
	}
	...
	public void destroy() {
		...
		TestrayFactorLocalServiceUtil.setService(null);
	}
	...
	public String getOSGiServiceIdentifier() {
		return TestrayFactorLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		DataSource dataSource = testrayFactorPersistence.getDataSource();
	...
	@BeanReference(type = TestrayFactorLocalService.class)
	protected TestrayFactorLocalService testrayFactorLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TestrayFactorLocalServiceBaseImpl.class);
