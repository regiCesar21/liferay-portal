...
import com.liferay.osb.testray.service.TestrayRoutineLocalService;
import com.liferay.osb.testray.service.TestrayRoutineLocalServiceUtil;
...
/**
 * Provides the base implementation for the testray routine local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.testray.service.impl.TestrayRoutineLocalServiceImpl}.
 * </p>
 *
 * @author Ethan Bustad
 ...
 * @generated
 */
public abstract class TestrayRoutineLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, TestrayRoutineLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TestrayRoutineLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>TestrayRoutineLocalServiceUtil</code>.
	 */
	 ...
	 *
	 * <p>
	 * <strong>Important:</strong> Inspect TestrayRoutineLocalServiceImpl for overloaded versions of the method. If provided, use these entry points to the API, as the implementation logic may require the additional parameters defined there.
	 * </p>
	 *
	...
	@Override
	public TestrayRoutine addTestrayRoutine(TestrayRoutine testrayRoutine) {
		testrayRoutine.setNew(true);

		return testrayRoutinePersistence.update(testrayRoutine);
	}
	...
	public TestrayRoutine createTestrayRoutine(long testrayRoutineId) {
		return testrayRoutinePersistence.create(testrayRoutineId);
	}
	...
	@Override
	public TestrayRoutine deleteTestrayRoutine(long testrayRoutineId)
		throws PortalException {

		return testrayRoutinePersistence.remove(testrayRoutineId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public TestrayRoutine deleteTestrayRoutine(TestrayRoutine testrayRoutine) {
		return testrayRoutinePersistence.remove(testrayRoutine);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			TestrayRoutine.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return testrayRoutinePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return testrayRoutinePersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return testrayRoutinePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return testrayRoutinePersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public TestrayRoutine fetchTestrayRoutine(long testrayRoutineId) {
		return testrayRoutinePersistence.fetchByPrimaryKey(testrayRoutineId);
	}
	 ...
	 */
	@Override
	public TestrayRoutine getTestrayRoutine(long testrayRoutineId)
		throws PortalException {

		return testrayRoutinePersistence.findByPrimaryKey(testrayRoutineId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(testrayRoutineLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(TestrayRoutine.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("testrayRoutineId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(TestrayRoutine.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return testrayRoutineLocalService.deleteTestrayRoutine(
			(TestrayRoutine)persistedModel);
	}

	public BasePersistence<TestrayRoutine> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return testrayRoutinePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<TestrayRoutine> getTestrayRoutines(int start, int end) {
		return testrayRoutinePersistence.findAll(start, end);
	}
	...
	public int getTestrayRoutinesCount() {
		return testrayRoutinePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TestrayRoutine updateTestrayRoutine(TestrayRoutine testrayRoutine) {
		return testrayRoutinePersistence.update(testrayRoutine);
	}
	 ...
	 */
	public TestrayRoutineLocalService getTestrayRoutineLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"com.liferay.osb.testray.model.TestrayRoutine",
			testrayRoutineLocalService);

		TestrayRoutineLocalServiceUtil.setService(testrayRoutineLocalService);
	}
	...
	public void destroy() {
		...
		TestrayRoutineLocalServiceUtil.setService(null);
	}
	...
	public String getOSGiServiceIdentifier() {
		return TestrayRoutineLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		DataSource dataSource = testrayRoutinePersistence.getDataSource();
	...
	@BeanReference(type = TestrayRoutineLocalService.class)
	protected TestrayRoutineLocalService testrayRoutineLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TestrayRoutineLocalServiceBaseImpl.class);
