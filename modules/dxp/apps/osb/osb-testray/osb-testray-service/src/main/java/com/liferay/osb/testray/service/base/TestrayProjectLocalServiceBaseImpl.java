...
import com.liferay.osb.testray.service.TestrayProjectLocalService;
...
/**
 * Provides the base implementation for the testray project local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.testray.service.impl.TestrayProjectLocalServiceImpl}.
 * </p>
 *
 * @author Ethan Bustad
 ...
 * @generated
 */
public abstract class TestrayProjectLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, TestrayProjectLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TestrayProjectLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>TestrayProjectLocalServiceUtil</code>.
	 */
	...
	@Override
	public TestrayProject addTestrayProject(TestrayProject testrayProject) {
		testrayProject.setNew(true);

		return testrayProjectPersistence.update(testrayProject);
	}
	...
	public TestrayProject createTestrayProject(long testrayProjectId) {
		return testrayProjectPersistence.create(testrayProjectId);
	}
	...
	@Override
	public TestrayProject deleteTestrayProject(long testrayProjectId)
		throws PortalException {

		return testrayProjectPersistence.remove(testrayProjectId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public TestrayProject deleteTestrayProject(TestrayProject testrayProject) {
		return testrayProjectPersistence.remove(testrayProject);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			TestrayProject.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return testrayProjectPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return testrayProjectPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return testrayProjectPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return testrayProjectPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public TestrayProject fetchTestrayProject(long testrayProjectId) {
		return testrayProjectPersistence.fetchByPrimaryKey(testrayProjectId);
	}
	 ...
	 */
	@Override
	public TestrayProject getTestrayProject(long testrayProjectId)
		throws PortalException {

		return testrayProjectPersistence.findByPrimaryKey(testrayProjectId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(testrayProjectLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(TestrayProject.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("testrayProjectId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(TestrayProject.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return testrayProjectLocalService.deleteTestrayProject(
			(TestrayProject)persistedModel);
	}

	public BasePersistence<TestrayProject> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return testrayProjectPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<TestrayProject> getTestrayProjects(int start, int end) {
		return testrayProjectPersistence.findAll(start, end);
	}
	...
	public int getTestrayProjectsCount() {
		return testrayProjectPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TestrayProject updateTestrayProject(TestrayProject testrayProject) {
		return testrayProjectPersistence.update(testrayProject);
	}
	 ...
	 */
	public TestrayProjectLocalService getTestrayProjectLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register(
			"com.liferay.osb.testray.model.TestrayProject",
			testrayProjectLocalService);

		TestrayProjectLocalServiceUtil.setService(testrayProjectLocalService);
	}
	...
	public void destroy() {
		...
		TestrayProjectLocalServiceUtil.setService(null);
	}
	...
	public String getOSGiServiceIdentifier() {
		return TestrayProjectLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		DataSource dataSource = testrayProjectPersistence.getDataSource();
	...
	@BeanReference(type = TestrayProjectLocalService.class)
	protected TestrayProjectLocalService testrayProjectLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TestrayProjectLocalServiceBaseImpl.class);
