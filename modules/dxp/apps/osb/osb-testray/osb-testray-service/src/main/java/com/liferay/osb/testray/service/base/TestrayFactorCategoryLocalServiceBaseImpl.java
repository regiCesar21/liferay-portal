...
import com.liferay.osb.testray.service.TestrayFactorCategoryLocalService;
...
/**
 * Provides the base implementation for the testray factor category local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.testray.service.impl.TestrayFactorCategoryLocalServiceImpl}.
 * </p>
 *
 * @author Ethan Bustad
 * @see com.liferay.osb.testray.service.impl.TestrayFactorCategoryLocalServiceImpl
 * @generated
 */
public abstract class TestrayFactorCategoryLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, TestrayFactorCategoryLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TestrayFactorCategoryLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>TestrayFactorCategoryLocalServiceUtil</code>.
	 */
	...
	@Override
	public TestrayFactorCategory addTestrayFactorCategory(
		TestrayFactorCategory testrayFactorCategory) {

		testrayFactorCategory.setNew(true);

		return testrayFactorCategoryPersistence.update(testrayFactorCategory);
	}
	...
	public TestrayFactorCategory createTestrayFactorCategory(
		long testrayFactorCategoryId) {

		return testrayFactorCategoryPersistence.create(testrayFactorCategoryId);
	}
	...
	@Override
	public TestrayFactorCategory deleteTestrayFactorCategory(
			long testrayFactorCategoryId)
		throws PortalException {

		return testrayFactorCategoryPersistence.remove(testrayFactorCategoryId);
	}
	...
	public TestrayFactorCategory deleteTestrayFactorCategory(
		...
		return testrayFactorCategoryPersistence.remove(testrayFactorCategory);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			TestrayFactorCategory.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return testrayFactorCategoryPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return testrayFactorCategoryPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public TestrayFactorCategory fetchTestrayFactorCategory(
		long testrayFactorCategoryId) {

		return testrayFactorCategoryPersistence.fetchByPrimaryKey(
	 ...
	 */
	@Override
	public TestrayFactorCategory getTestrayFactorCategory(
			long testrayFactorCategoryId)
		throws PortalException {

		return testrayFactorCategoryPersistence.findByPrimaryKey(
			testrayFactorCategoryId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(TestrayFactorCategory.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return testrayFactorCategoryLocalService.deleteTestrayFactorCategory(
			(TestrayFactorCategory)persistedModel);
	}

	public BasePersistence<TestrayFactorCategory> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return testrayFactorCategoryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<TestrayFactorCategory> getTestrayFactorCategories(
		int start, int end) {

		return testrayFactorCategoryPersistence.findAll(start, end);
	}
	...
	public int getTestrayFactorCategoriesCount() {
		return testrayFactorCategoryPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TestrayFactorCategory updateTestrayFactorCategory(
		TestrayFactorCategory testrayFactorCategory) {
	 ...
	 */
	public TestrayFactorCategoryLocalService
	...
	public void afterPropertiesSet() {
		...
		TestrayFactorCategoryLocalServiceUtil.setService(
			testrayFactorCategoryLocalService);
	}
	...
	public void destroy() {
		...
		TestrayFactorCategoryLocalServiceUtil.setService(null);
	}
	...
	public String getOSGiServiceIdentifier() {
		return TestrayFactorCategoryLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		DataSource dataSource =
			testrayFactorCategoryPersistence.getDataSource();
	...
	@BeanReference(type = TestrayFactorCategoryLocalService.class)
	protected TestrayFactorCategoryLocalService
		testrayFactorCategoryLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TestrayFactorCategoryLocalServiceBaseImpl.class);
