...
/**
 * Provides the base implementation for the testray team local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.testray.service.impl.TestrayTeamLocalServiceImpl}.
 * </p>
 *
 * @author Ethan Bustad
...
public abstract class TestrayTeamLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TestrayTeamLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>TestrayTeamLocalServiceUtil</code>.
	 */
	...
	public TestrayTeam addTestrayTeam(TestrayTeam testrayTeam) {
		...
		return testrayTeamPersistence.update(testrayTeam);
	}
	...
	public TestrayTeam deleteTestrayTeam(TestrayTeam testrayTeam) {
		return testrayTeamPersistence.remove(testrayTeam);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return testrayTeamPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public TestrayTeam fetchTestrayTeam(long testrayTeamId) {
		return testrayTeamPersistence.fetchByPrimaryKey(testrayTeamId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setPrimaryKeyPropertyName("testrayTeamId");
	...
	public List<TestrayTeam> getTestrayTeams(int start, int end) {
		return testrayTeamPersistence.findAll(start, end);
	}
	...
	public int getTestrayTeamsCount() {
		return testrayTeamPersistence.countAll();
	}
	 ...
	 */
	public TestrayTeamLocalService getTestrayTeamLocalService() {
	...
	public void afterPropertiesSet() {
		...
		TestrayTeamLocalServiceUtil.setService(testrayTeamLocalService);
	}
	...
	public void destroy() {
		...
		TestrayTeamLocalServiceUtil.setService(null);
	}
	...
	public String getOSGiServiceIdentifier() {
		return TestrayTeamLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		DataSource dataSource = testrayTeamPersistence.getDataSource();
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TestrayTeamLocalServiceBaseImpl.class);
