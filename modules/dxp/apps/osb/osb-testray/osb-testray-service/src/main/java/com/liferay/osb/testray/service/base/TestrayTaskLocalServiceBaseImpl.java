...
import com.liferay.osb.testray.service.TestrayTaskLocalService;
...
/**
 * Provides the base implementation for the testray task local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.testray.service.impl.TestrayTaskLocalServiceImpl}.
 * </p>
 *
 * @author Ethan Bustad
 * @see com.liferay.osb.testray.service.impl.TestrayTaskLocalServiceImpl
 * @generated
 */
public abstract class TestrayTaskLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements IdentifiableOSGiService, TestrayTaskLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TestrayTaskLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>TestrayTaskLocalServiceUtil</code>.
	 */
	...
	@Override
	public TestrayTask addTestrayTask(TestrayTask testrayTask) {
		testrayTask.setNew(true);

		return testrayTaskPersistence.update(testrayTask);
	}
	...
	public TestrayTask createTestrayTask(long testrayTaskId) {
		return testrayTaskPersistence.create(testrayTaskId);
	}
	...
	@Override
	public TestrayTask deleteTestrayTask(long testrayTaskId)
		throws PortalException {

		return testrayTaskPersistence.remove(testrayTaskId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public TestrayTask deleteTestrayTask(TestrayTask testrayTask) {
		return testrayTaskPersistence.remove(testrayTask);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			TestrayTask.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return testrayTaskPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return testrayTaskPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return testrayTaskPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return testrayTaskPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public TestrayTask fetchTestrayTask(long testrayTaskId) {
		return testrayTaskPersistence.fetchByPrimaryKey(testrayTaskId);
	}
	 ...
	 */
	@Override
	public TestrayTask getTestrayTask(long testrayTaskId)
		throws PortalException {

		return testrayTaskPersistence.findByPrimaryKey(testrayTaskId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(testrayTaskLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(TestrayTask.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("testrayTaskId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(TestrayTask.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return testrayTaskLocalService.deleteTestrayTask(
			(TestrayTask)persistedModel);
	}

	public BasePersistence<TestrayTask> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return testrayTaskPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<TestrayTask> getTestrayTasks(int start, int end) {
		return testrayTaskPersistence.findAll(start, end);
	}
	...
	public int getTestrayTasksCount() {
		return testrayTaskPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TestrayTask updateTestrayTask(TestrayTask testrayTask) {
		return testrayTaskPersistence.update(testrayTask);
	}
	...
	public void addTestrayCaseTypeTestrayTask(
		...
		testrayCaseTypePersistence.addTestrayTask(
	...
	public void addTestrayCaseTypeTestrayTasks(
		...
		testrayCaseTypePersistence.addTestrayTasks(
	...
	public void clearTestrayCaseTypeTestrayTasks(long testrayCaseTypeId) {
		testrayCaseTypePersistence.clearTestrayTasks(testrayCaseTypeId);
	}
	...
	public void deleteTestrayCaseTypeTestrayTask(
		...
		testrayCaseTypePersistence.removeTestrayTask(
			testrayCaseTypeId, testrayTaskId);
	}
	...
	public void deleteTestrayCaseTypeTestrayTasks(
		...
		testrayCaseTypePersistence.removeTestrayTasks(
			testrayCaseTypeId, testrayTaskIds);
	}
	...
	public long[] getTestrayCaseTypePrimaryKeys(long testrayTaskId) {
		return testrayTaskPersistence.getTestrayCaseTypePrimaryKeys(
			testrayTaskId);
	}
	 ...
	 */
	@Override
	public List<TestrayTask> getTestrayCaseTypeTestrayTasks(
		long testrayCaseTypeId) {

		return testrayCaseTypePersistence.getTestrayTasks(testrayCaseTypeId);
	}
	...
	public List<TestrayTask> getTestrayCaseTypeTestrayTasks(
		...
		return testrayCaseTypePersistence.getTestrayTasks(
	...
	public int getTestrayCaseTypeTestrayTasksCount(long testrayCaseTypeId) {
		return testrayCaseTypePersistence.getTestrayTasksSize(
			testrayCaseTypeId);
	}
	...
	public boolean hasTestrayCaseTypeTestrayTask(
		...
		return testrayCaseTypePersistence.containsTestrayTask(
			testrayCaseTypeId, testrayTaskId);
	}
	...
	public boolean hasTestrayCaseTypeTestrayTasks(long testrayCaseTypeId) {
		return testrayCaseTypePersistence.containsTestrayTasks(
			testrayCaseTypeId);
	}
	...
	public void setTestrayCaseTypeTestrayTasks(
		...
		testrayCaseTypePersistence.setTestrayTasks(
			testrayCaseTypeId, testrayTaskIds);
	}
	 ...
	 */
	public TestrayTaskLocalService getTestrayTaskLocalService() {
	...
	public void afterPropertiesSet() {
		...
		TestrayTaskLocalServiceUtil.setService(testrayTaskLocalService);
	}
	...
	public void destroy() {
		...
		TestrayTaskLocalServiceUtil.setService(null);
	}
	...
	public String getOSGiServiceIdentifier() {
		return TestrayTaskLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		DataSource dataSource = testrayTaskPersistence.getDataSource();
	...
	@BeanReference(type = TestrayTaskLocalService.class)
	protected TestrayTaskLocalService testrayTaskLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TestrayTaskLocalServiceBaseImpl.class);
