...
package com.liferay.osb.koroneiki.xylem.distributed.messaging.internal.pubsub.broker;
...
import com.liferay.osb.koroneiki.xylem.distributed.messaging.internal.pubsub.ISOpsServiceAccountCredentialsProvider;
...
@Component(
	immediate = true,
	property = {"projectId=is-ops-dev", "publishing.topic.pattern=okta.*"},
