...
public interface OktaUserResource {
	...
	public HttpInvoker.HttpResponse postOktaUserHttpResponse(
			String agentName, String agentUID, OktaUser oktaUser)
		throws Exception;
	...
	public static class Builder {
		...
		public OktaUserResource build() {
			return new OktaUserResourceImpl(this);
		}
	...
	public static class OktaUserResourceImpl implements OktaUserResource {

		public void postOktaUser(
				String agentName, String agentUID, OktaUser oktaUser)
			throws Exception {

			HttpInvoker.HttpResponse httpResponse = postOktaUserHttpResponse(
		...
		public HttpInvoker.HttpResponse postOktaUserHttpResponse(
			...
			httpInvoker.body(oktaUser.toString(), "application/json");
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/koroneiki-rest/v1.0/okta-users");
		...
		private OktaUserResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			OktaUserResource.class.getName());
