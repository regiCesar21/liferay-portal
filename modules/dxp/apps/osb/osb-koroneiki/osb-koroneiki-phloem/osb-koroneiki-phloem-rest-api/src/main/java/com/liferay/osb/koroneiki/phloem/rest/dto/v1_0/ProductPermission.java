...
public class ProductPermission implements Serializable {
	...
	public Boolean getConsume() {
		if (_consumeSupplier != null) {
			consume = _consumeSupplier.get();

			_consumeSupplier = null;
		}
	...
	public void setConsume(
		...
		_consumeSupplier = () -> {
			try {
				return consumeUnsafeSupplier.get();
			}
	...
	private Supplier<Boolean> _consumeSupplier;
