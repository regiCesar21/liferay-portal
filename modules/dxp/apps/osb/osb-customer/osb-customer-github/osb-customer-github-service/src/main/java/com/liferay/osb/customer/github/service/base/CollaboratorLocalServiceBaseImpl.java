...
package com.liferay.osb.customer.github.service.base;
...
/**
 * Provides the base implementation for the collaborator local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.osb.customer.github.service.impl.CollaboratorLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class CollaboratorLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements CollaboratorLocalService, IdentifiableOSGiService {
	...
	public Collaborator createCollaborator(long collaboratorId) {
		return collaboratorPersistence.create(collaboratorId);
	}
	...
	public Collaborator deleteCollaborator(long collaboratorId)
		...
		return collaboratorPersistence.remove(collaboratorId);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Collaborator.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return collaboratorPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return collaboratorPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return collaboratorPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return collaboratorPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public Collaborator fetchCollaborator(long collaboratorId) {
		return collaboratorPersistence.fetchByPrimaryKey(collaboratorId);
	}
	...
	public Collaborator getCollaborator(long collaboratorId)
		...
		return collaboratorPersistence.findByPrimaryKey(collaboratorId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(collaboratorLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Collaborator.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("collaboratorId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(Collaborator.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return collaboratorLocalService.deleteCollaborator(
			(Collaborator)persistedModel);
	}

	public BasePersistence<Collaborator> getBasePersistence() {
		return collaboratorPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return collaboratorPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<Collaborator> getCollaborators(int start, int end) {
		return collaboratorPersistence.findAll(start, end);
	}
	...
	public int getCollaboratorsCount() {
		return collaboratorPersistence.countAll();
	}
	...
	/**
	 * Returns the collaborator local service.
	 *
	 * @return the collaborator local service
	 */
	public CollaboratorLocalService getCollaboratorLocalService() {
		return collaboratorLocalService;
	}

	/**
	 * Sets the collaborator local service.
	 *
	 * @param collaboratorLocalService the collaborator local service
	 */
	public void setCollaboratorLocalService(
		CollaboratorLocalService collaboratorLocalService) {

		this.collaboratorLocalService = collaboratorLocalService;
	}

	/**
	 * Returns the collaborator persistence.
	 *
	 * @return the collaborator persistence
	 */
	public CollaboratorPersistence getCollaboratorPersistence() {
		return collaboratorPersistence;
	}

	/**
	 * Sets the collaborator persistence.
	 *
	 * @param collaboratorPersistence the collaborator persistence
	 */
	public void setCollaboratorPersistence(
	...
	public void afterPropertiesSet() {
		...
		CollaboratorLocalServiceUtil.setService(collaboratorLocalService);
	}
	...
	public void destroy() {
		...
		CollaboratorLocalServiceUtil.setService(null);
	}
	...
	public String getOSGiServiceIdentifier() {
		return CollaboratorLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		DataSource dataSource = collaboratorPersistence.getDataSource();
	...
	@BeanReference(type = CollaboratorLocalService.class)
	protected CollaboratorLocalService collaboratorLocalService;

	@BeanReference(type = CollaboratorPersistence.class)
	protected CollaboratorPersistence collaboratorPersistence;
