...
public class AppWorkflowDataRecordLinkResourceFactoryImpl
	...
	public AppWorkflowDataRecordLinkResource.Builder create() {
		return new AppWorkflowDataRecordLinkResource.Builder() {
			...
			@Override
			public AppWorkflowDataRecordLinkResource.Builder uriInfo(
				UriInfo uriInfo) {
	...
	private static Function
		...
		Class<?> proxyClass = ProxyUtil.getProxyClass(
			AppWorkflowDataRecordLinkResource.class.getClassLoader(),
			AppWorkflowDataRecordLinkResource.class);

		try {
			Constructor<AppWorkflowDataRecordLinkResource> constructor =
				(Constructor<AppWorkflowDataRecordLinkResource>)
	...
	private Object _invoke(
		...
		appWorkflowDataRecordLinkResource.setContextHttpServletResponse(
			httpServletResponse);
		appWorkflowDataRecordLinkResource.setContextUriInfo(uriInfo);
		...
		appWorkflowDataRecordLinkResource.setRoleLocalService(
			_roleLocalService);
		appWorkflowDataRecordLinkResource.setSortParserProvider(
			_sortParserProvider);
