...
import com.liferay.app.builder.workflow.rest.internal.security.permission.LiberalPermissionChecker;
...
public class AppWorkflowResourceFactoryImpl
	...
	public AppWorkflowResource.Builder create() {
		return new AppWorkflowResource.Builder() {
			...
			@Override
			public AppWorkflowResource.Builder uriInfo(UriInfo uriInfo) {
				_uriInfo = uriInfo;
	...
	private static Function<InvocationHandler, AppWorkflowResource>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			AppWorkflowResource.class.getClassLoader(),
			AppWorkflowResource.class);

		try {
			Constructor<AppWorkflowResource> constructor =
				(Constructor<AppWorkflowResource>)proxyClass.getConstructor(
	...
	private Object _invoke(
		...
		appWorkflowResource.setContextUriInfo(uriInfo);
		...
		appWorkflowResource.setSortParserProvider(_sortParserProvider);
