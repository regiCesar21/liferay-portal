...
public class RenameFinderColumnEntryPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_argumentsResolverServiceRegistration = _bundleContext.registerService(
			...
			new RenameFinderColumnEntryModelArgumentsResolver(),
			MapUtil.singletonDictionary(
				"model.class.name", RenameFinderColumnEntry.class.getName()));
		...
		_finderPathFetchByColumnToRename = _createFinderPath(
	...
	private static class RenameFinderColumnEntryModelArgumentsResolver
