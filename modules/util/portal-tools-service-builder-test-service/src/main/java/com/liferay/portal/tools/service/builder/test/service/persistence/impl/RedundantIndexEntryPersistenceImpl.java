...
public class RedundantIndexEntryPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_argumentsResolverServiceRegistration = _bundleContext.registerService(
			...
			new RedundantIndexEntryModelArgumentsResolver(),
			MapUtil.singletonDictionary(
				"model.class.name", RedundantIndexEntry.class.getName()));
	...
	private static class RedundantIndexEntryModelArgumentsResolver
		...
		public Object[] getArguments(
			...
			long columnBitmask =
				redundantIndexEntryModelImpl.getColumnBitmask();
