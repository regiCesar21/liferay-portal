...
public class SpringEntryPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_argumentsResolverServiceRegistration = _bundleContext.registerService(
			ArgumentsResolver.class, new SpringEntryModelArgumentsResolver(),
			MapUtil.singletonDictionary(
				"model.class.name", SpringEntry.class.getName()));
	...
	private static class SpringEntryModelArgumentsResolver
		...
		private static Object[] _getValue(
			...
			for (int i = 0; i < arguments.length; i++) {
				...
				if (original) {
					...
					arguments[i] = springEntryModelImpl.getColumnValue(
						columnName);
				}
			}
