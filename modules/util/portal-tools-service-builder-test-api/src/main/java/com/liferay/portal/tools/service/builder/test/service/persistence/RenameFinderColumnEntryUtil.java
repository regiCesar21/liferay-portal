...
public class RenameFinderColumnEntryUtil {
	...
	public static RenameFinderColumnEntry findByColumnToRename(
		...
		return getPersistence().findByColumnToRename(renamedColumn);
	}
	...
	public static RenameFinderColumnEntry fetchByColumnToRename(
		...
		return getPersistence().fetchByColumnToRename(renamedColumn);
	}
	...
	public static RenameFinderColumnEntry removeByColumnToRename(
		...
		return getPersistence().removeByColumnToRename(renamedColumn);
	}
	 ...
	 */
	public static int countByColumnToRename(String renamedColumn) {
		return getPersistence().countByColumnToRename(renamedColumn);
	}
