 ...
 * @return {object}
 */
export default function getSelectedField({fieldSets, mappingFieldsKey, value}) {
	if (!value || !fieldSets?.length) {
		return null;
	}
	...
	const flattenField = fieldSets.flatMap((fieldSet) => fieldSet.fields);
