...
public abstract class JournalArticleImageLocalServiceBaseImpl
	...
	implements IdentifiableOSGiService, JournalArticleImageLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>JournalArticleImageLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>JournalArticleImageLocalServiceUtil</code>.
	 */
	...
	public BasePersistence<JournalArticleImage> getBasePersistence() {
	...
	private static final Log _log = LogFactoryUtil.getLog(
		JournalArticleImageLocalServiceBaseImpl.class);
