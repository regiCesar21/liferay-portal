...
public class FragmentEntryLinkUtil {
	...
	public static List<FragmentEntryLink> findByC_R(
		...
		return getPersistence().findByC_R(companyId, rendererKeies);
	}
	...
	public static List<FragmentEntryLink> findByC_R(
		...
		return getPersistence().findByC_R(companyId, rendererKeies, start, end);
	}
	...
	public static List<FragmentEntryLink> findByC_R(
		...
		return getPersistence().findByC_R(
			companyId, rendererKeies, start, end, orderByComparator);
	}
	 ...
	 * @return the number of matching fragment entry links
	 */
	public static int countByC_R(long companyId, String[] rendererKeies) {
		return getPersistence().countByC_R(companyId, rendererKeies);
	}
