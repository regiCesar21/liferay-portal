...
import com.liferay.account.rest.internal.security.permission.LiberalPermissionChecker;
...
public class AccountUserResourceFactoryImpl
	...
	public AccountUserResource.Builder create() {
		return new AccountUserResource.Builder() {
			...
			public AccountUserResource build() {
				...
				Function<InvocationHandler, AccountUserResource>
					accountUserResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_accountUserResourceProxyProviderFunction;

				return accountUserResourceProxyProviderFunction.apply(
			...
			@Override
			public AccountUserResource.Builder uriInfo(UriInfo uriInfo) {
				_uriInfo = uriInfo;
	...
	private static Function<InvocationHandler, AccountUserResource>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			AccountUserResource.class.getClassLoader(),
			AccountUserResource.class);

		try {
			Constructor<AccountUserResource> constructor =
				(Constructor<AccountUserResource>)proxyClass.getConstructor(
	...
	private Object _invoke(
		...
		accountUserResource.setContextUriInfo(uriInfo);
		...
		accountUserResource.setSortParserProvider(_sortParserProvider);
	...
	private static class ResourceProxyProviderFunctionHolder {
		...
		private static final Function<InvocationHandler, AccountUserResource>
			_accountUserResourceProxyProviderFunction =
				_getProxyProviderFunction();
