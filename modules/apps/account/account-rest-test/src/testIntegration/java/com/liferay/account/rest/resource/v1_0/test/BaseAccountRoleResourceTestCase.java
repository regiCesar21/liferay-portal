...
public abstract class BaseAccountRoleResourceTestCase {
	...
	protected Map<String, Map<String, String>>
			testGetAccountRolesPage_getExpectedActions(Long accountId)
		throws Exception {
	...
	public void testGetAccountRolesPageWithPagination() throws Exception {
		...
		if (totalCount >= (pageSizeLimit - 2)) {
			...
			Page<AccountRole> page1 = accountRoleResource.getAccountRolesPage(
				accountId, null, Pagination.of(1, totalCount + 2), null);
			...
			Page<AccountRole> page2 = accountRoleResource.getAccountRolesPage(
				accountId, null, Pagination.of(2, totalCount + 2), null);
			...
			Page<AccountRole> page3 = accountRoleResource.getAccountRolesPage(
				accountId, null, Pagination.of(1, (int)totalCount + 3), null);
	...
	public void testGraphQLGetAccountRolesPage() throws Exception {
		...
		long totalCount = accountRolesJSONObject.getLong("totalCount");
		...
		Assert.assertEquals(
			totalCount + 2, accountRolesJSONObject.getLong("totalCount"));
	...
	public void testPostAccountRoleUserAssociation() throws Exception {
		...
		assertHttpResponseStatusCode(
			...
			accountRoleResource.postAccountRoleUserAssociationHttpResponse(
				testPostAccountRoleUserAssociation_getAccountId(accountRole),
				accountRole.getId(),
				testPostAccountRoleUserAssociation_getAccountUserId()));

		assertHttpResponseStatusCode(
			404,
			accountRoleResource.postAccountRoleUserAssociationHttpResponse(
				testPostAccountRoleUserAssociation_getAccountId(accountRole),
				0L, testPostAccountRoleUserAssociation_getAccountUserId()));
	}

	protected Long testPostAccountRoleUserAssociation_getAccountId(
			AccountRole accountRole)
		throws Exception {
	...
	protected Long testPostAccountRoleUserAssociation_getAccountUserId()
		throws Exception {
		...
		assertHttpResponseStatusCode(
			...
			accountRoleResource.
				postAccountRoleUserAssociationByExternalReferenceCodeHttpResponse(
					testPostAccountRoleUserAssociationByExternalReferenceCode_getAccountExternalReferenceCode(),
					accountRole.getId(),
					testPostAccountRoleUserAssociationByExternalReferenceCode_getAccountUserExternalReferenceCode()));
