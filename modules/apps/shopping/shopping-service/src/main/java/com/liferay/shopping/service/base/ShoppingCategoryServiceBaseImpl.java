 ...
 * @generated
 */
public abstract class ShoppingCategoryServiceBaseImpl
	extends BaseServiceImpl
	implements IdentifiableOSGiService, ShoppingCategoryService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ShoppingCategoryService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ShoppingCategoryServiceUtil</code>.
	 */
	...
	public void afterPropertiesSet() {
		ShoppingCategoryServiceUtil.setService(shoppingCategoryService);
	}

	public void destroy() {
		ShoppingCategoryServiceUtil.setService(null);
	}
