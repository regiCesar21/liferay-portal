...
public class PortalSQLProvider implements SQLProvider {
	...
	private void _appendPluginsSQL() throws Exception {
		...
		for (PluginPackage pluginPackage :
			...
			_appendSQL(
				_getSQLTemplateString(contextName, "indexes.sql"),
				_getSQLTemplateString(contextName, "tables.sql"));
		}
	}
	...
	private String _getSQLTemplateString(
			String contextName, String templateName)
		throws Exception {
