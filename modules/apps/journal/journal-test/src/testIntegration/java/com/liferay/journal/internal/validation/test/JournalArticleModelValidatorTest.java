...
public class JournalArticleModelValidatorTest {
	...
	public void testValidateReferences() throws PortalException {
		ReflectionTestUtil.invoke(
			...
			new Class<?>[] {
				...
				String.class, boolean.class, String.class, byte[].class,
				long.class, String.class
			},
			_group.getGroupId(), 0, _ddmStructure.getStructureKey(),
			_ddmTemplate.getTemplateKey(), null, false, null, null, 0,
			StringPool.BLANK);
	}
	...
	public void testValidateReferencesInvalidDDMStructureId()
		...
		ReflectionTestUtil.invoke(
			...
			_group.getGroupId(), 0, null, _ddmTemplate.getTemplateKey(), null,
			false, null, null, 0, StringPool.BLANK);
	}
	...
	public void testValidateReferencesInvalidFolderId() throws PortalException {
		ReflectionTestUtil.invoke(
			...
			_group.getGroupId(), -1, _ddmStructure.getStructureKey(),
			_ddmTemplate.getTemplateKey(), null, false, null, null, 0,
			StringPool.BLANK);
	}
