...
public class BatchEngineImportTaskServiceHttp {
	...
	public static com.liferay.batch.engine.model.BatchEngineImportTask
		...
		try {
			...
			MethodHandler methodHandler = new MethodHandler(
				methodKey, companyId, userId, batchSize, callbackURL, className,
				content, contentType, executeStatus, fieldNameMappingMap,
	...
	public static com.liferay.batch.engine.model.BatchEngineImportTask
		...
		try {
			MethodKey methodKey = new MethodKey(
				BatchEngineImportTaskServiceUtil.class,
				"getBatchEngineImportTask",
				_getBatchEngineImportTaskParameterTypes1);
	...
	private static final Class<?>[] _addBatchEngineImportTaskParameterTypes0 =
		new Class[] {
			...
			byte[].class, String.class, String.class, java.util.Map.class,
			String.class, java.util.Map.class, String.class
		};
	private static final Class<?>[] _getBatchEngineImportTaskParameterTypes1 =
