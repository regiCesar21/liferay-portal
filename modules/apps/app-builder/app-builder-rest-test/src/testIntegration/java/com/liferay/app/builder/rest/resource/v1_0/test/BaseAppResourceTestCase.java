...
public abstract class BaseAppResourceTestCase {
	...
	public void setUp() throws Exception {
		...
		appResource = AppResource.builder(
		).authentication(
	...
	public void testGetAppsPageWithSortDouble() throws Exception {
		testGetAppsPageWithSort(
			...
			(entityField, app1, app2) -> {
				BeanTestUtil.setProperty(app1, entityField.getName(), 0.1);
				BeanTestUtil.setProperty(app2, entityField.getName(), 0.5);
			});
	}
	...
	public void testGetAppsPageWithSortInteger() throws Exception {
		testGetAppsPageWithSort(
			...
			(entityField, app1, app2) -> {
				BeanTestUtil.setProperty(app1, entityField.getName(), 0);
				BeanTestUtil.setProperty(app2, entityField.getName(), 1);
			});
	}
	...
	protected String getFilterString(
		...
		if (entityFieldName.equals("dataDefinitionName")) {
			Object object = app.getDataDefinitionName();
		...
		if (entityFieldName.equals("dateCreated")) {
			if (operator.equals("between")) {
				...
				sb.append(_format.format(app.getDateCreated()));
			}
		...
		if (entityFieldName.equals("dateModified")) {
			if (operator.equals("between")) {
				...
				sb.append(_format.format(app.getDateModified()));
			}
