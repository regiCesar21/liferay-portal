...
public class AppResourceFactoryImpl implements AppResource.Factory {
	...
	public AppResource.Builder create() {
		return new AppResource.Builder() {
			...
			public AppResource build() {
				...
				Function<InvocationHandler, AppResource>
					appResourceProxyProviderFunction =
						ResourceProxyProviderFunctionHolder.
							_appResourceProxyProviderFunction;

				return appResourceProxyProviderFunction.apply(
			...
			@Override
			public AppResource.Builder uriInfo(UriInfo uriInfo) {
				_uriInfo = uriInfo;
	...
	private Object _invoke(
		...
		appResource.setContextUriInfo(uriInfo);
