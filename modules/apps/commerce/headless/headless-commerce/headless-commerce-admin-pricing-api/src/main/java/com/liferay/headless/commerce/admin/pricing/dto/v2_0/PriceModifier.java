...
public class PriceModifier implements Serializable {
	...
	public PriceModifierCategory[] getPriceModifierCategory() {
		if (_priceModifierCategorySupplier != null) {
			priceModifierCategory = _priceModifierCategorySupplier.get();

			_priceModifierCategorySupplier = null;
		}
	...
	public void setPriceModifierCategory(
		...
		_priceModifierCategorySupplier = () -> {
			try {
				return priceModifierCategoryUnsafeSupplier.get();
			}
			catch (RuntimeException runtimeException) {
				throw runtimeException;
			}
	...
	public PriceModifierProduct[] getPriceModifierProduct() {
		if (_priceModifierProductSupplier != null) {
			priceModifierProduct = _priceModifierProductSupplier.get();

			_priceModifierProductSupplier = null;
		}
	...
	public void setPriceModifierProduct(
		...
		_priceModifierProductSupplier = () -> {
			try {
				return priceModifierProductUnsafeSupplier.get();
			}
			catch (RuntimeException runtimeException) {
				throw runtimeException;
			}
	...
	public PriceModifierProductGroup[] getPriceModifierProductGroup() {
		if (_priceModifierProductGroupSupplier != null) {
			priceModifierProductGroup =
				_priceModifierProductGroupSupplier.get();

			_priceModifierProductGroupSupplier = null;
		}
	...
	public void setPriceModifierProductGroup(
		...
		_priceModifierProductGroupSupplier = () -> {
			try {
				return priceModifierProductGroupUnsafeSupplier.get();
			}
			catch (RuntimeException runtimeException) {
				throw runtimeException;
			}
	...
	public String toString() {
		...
		PriceModifierProduct[] priceModifierProduct = getPriceModifierProduct();
