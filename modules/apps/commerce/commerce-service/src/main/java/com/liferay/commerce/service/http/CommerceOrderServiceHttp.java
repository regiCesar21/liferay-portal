...
public class CommerceOrderServiceHttp {
	...
	public static com.liferay.commerce.model.CommerceOrder updateCustomFields(
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_updateCustomFieldsParameterTypes45);
	...
	public static com.liferay.commerce.model.CommerceOrder updateTransactionId(
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				_updateTransactionIdParameterTypes54);
	...
	private static final Class<?>[] _updateCustomFieldsParameterTypes45 =
		new Class[] {
	...
	private static final Class<?>[] _updateTransactionIdParameterTypes54 =
		new Class[] {long.class, String.class};
