...
public class BookmarksFolderPersistenceImpl
	 ...
	 */
	@Override
	public List<BookmarksFolder> findByResourceBlockId(
	 ...
	 */
	@Override
	public BookmarksFolder findByResourceBlockId_First(
			long resourceBlockId,
			OrderByComparator<BookmarksFolder> orderByComparator)
		throws NoSuchFolderException {

		BookmarksFolder bookmarksFolder = fetchByResourceBlockId_First(
	 ...
	 */
	@Override
	public BookmarksFolder fetchByResourceBlockId_First(
		long resourceBlockId,
		OrderByComparator<BookmarksFolder> orderByComparator) {

		List<BookmarksFolder> list = findByResourceBlockId(
	 ...
	 */
	@Override
	public BookmarksFolder findByResourceBlockId_Last(
			long resourceBlockId,
			OrderByComparator<BookmarksFolder> orderByComparator)
		throws NoSuchFolderException {

		BookmarksFolder bookmarksFolder = fetchByResourceBlockId_Last(
			resourceBlockId, orderByComparator);
	 ...
	 */
	@Override
	public BookmarksFolder fetchByResourceBlockId_Last(
		long resourceBlockId,
		OrderByComparator<BookmarksFolder> orderByComparator) {
	 ...
	 */
	@Override
	public BookmarksFolder[] findByResourceBlockId_PrevAndNext(
		...
		try {
			...
			array[0] = getByResourceBlockId_PrevAndNext(
				session, bookmarksFolder, resourceBlockId, orderByComparator,
				true);
