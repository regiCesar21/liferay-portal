...
public class AnalyticsAssociationPersistenceImpl
	...
	public void activate(BundleContext bundleContext) {
		...
		_argumentsResolverServiceRegistration = _bundleContext.registerService(
			...
			new AnalyticsAssociationModelArgumentsResolver(),
			MapUtil.singletonDictionary(
				"model.class.name", AnalyticsAssociation.class.getName()));
		...
		_finderPathWithPaginationFindByC_GtM_A = _createFinderPath(
		...
		_finderPathWithPaginationCountByC_GtM_A = _createFinderPath(
		...
		_finderPathWithPaginationFindByC_A_A = _createFinderPath(
		...
		_finderPathWithoutPaginationFindByC_A_A = _createFinderPath(
		...
		_finderPathCountByC_A_A = _createFinderPath(
	...
	private static class AnalyticsAssociationModelArgumentsResolver
