...
public class UserAccount implements Serializable {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		deprecated = true, description = "The user's contact information."
	)
	@Valid
	public ContactInformation getContactInformation() {
		if (_contactInformationSupplier != null) {
			contactInformation = _contactInformationSupplier.get();

			_contactInformationSupplier = null;
		}
	...
	public void setContactInformation(
		...
		_contactInformationSupplier = () -> {
			try {
				return contactInformationUnsafeSupplier.get();
			}
			catch (RuntimeException runtimeException) {
				throw runtimeException;
			}
